    ...
    return (
        <section className='my-10 sm:flex min-h-[200px] justify-center p-5 items-center' id="skills">
            ...
            <div className='max-w-lg'>
                ...
                <p className="Javascript text-gray-800 dark:text-white hidden text-center"> JavaScript é uma linguagem de programação interpretada estruturada, de script em alto nível com tipagem dinâmica fraca e multiparadigma. Juntamente com HTML e CSS, o JavaScript é uma das três principais tecnologias da World Wide Web. </p>
                <p className="react text-gray-800 dark:text-white hidden text-center"> O React é uma biblioteca JavaScript de código aberto com foco em criar interfaces de usuário em páginas web. É mantido pelo Facebook, Instagram, outras empresas e uma comunidade de desenvolvedores individuais. É utilizado nos sites da Netflix, Imgur, Feedly, Airbnb, SeatGeek, HelloSign, Walmart e outros. </p>
                <p className="css text-gray-800 dark:text-white hidden text-center" >  Trata-se de uma linguagem de marcação, amplamente utilizada com HTML ou XHTML, e representa diversas possibilidades para a formatação. O CSS ajuda a editar, alinhar, remover e trabalhar no espaço entre elementos de uma página. </p>
                <p className="html text-gray-800 dark:text-white hidden text-center" >   Linguagem de Marcação de Hipertexto. O HTML é o componente básico da web, ele permite inserir o conteúdo e estabelecer a estrutura básica de um website. </p>
                <p className="vuejs text-gray-800 dark:text-white hidden text-center" >  Vue.js é um framework JavaScript de código-aberto, focado no desenvolvimento de interfaces de usuário e aplicativos de página única </p>
                <p className="WordPress text-gray-800 dark:text-white hidden text-center"> O WordPress é o CMS mais usado no mundo, e por bons motivos. Além de flexível e gratuito, ele conta com várias outras vantagens em relação aos demais CMS's </p>
                <p className="Figma text-gray-800 dark:text-white hidden text-center"> Figma é um editor online de design gráfico focado na criação de interfaces gráficas e experiência de usuário com ênfase colaborativa.  </p>
                <p className="Sass text-gray-800 dark:text-white hidden text-center" > O SASS é uma linguagem de extensão do CSS, a sigla significa “Syntactically Awesome Style Sheets” traduzindo ao pé da letra, folhas de estilo com uma sintaxe incrível. A sua ideia é adicionar recursos especiais como variáveis, mixins, funções e operações e outras opções variadas que iremos comentar. O SASS tem como objetivo tornar o processo de desenvolvimento mais simples e eficiente, agora, veremos alguns exemplos da versatilidade dessa tecnologia. </p>
                <p className="tailwind text-gray-800 dark:text-white hidden text-center" >  Tailwind é um framework CSS que permite há você criar layouts para suas aplicações web utilizando sua estrutura. Ou seja, uma ferramenta que fornece componentes para sua estilização agilizando os processos de criação de web sites. Trazendo classes estilizadas a serem incluídas no CSS, com o uso de utility-first que são classes utilitárias que representam atributos CSS, como width, border e background.</p>
                <p className="blade text-gray-800 dark:text-white hidden text-center" >  Blade, é um engine templates do framework Laravel que possibilita o reuso de código e simplifica a inserção de trechos PHP em páginas HTML.</p>
                <p className="seo text-gray-800 dark:text-white hidden text-center" >   Seo  é o conjunto de técnicas usadas, geralmente divididas entre tecnologia, conteúdo e autoridade, para alcançar bom posicionamento de páginas de um site no Google e em outros buscadores, gerando tráfego orgânico.</p>
                <p className="responsividade text-gray-800 dark:text-white hidden text-center" >  Um site responsivo é aquele cuja disposição dos elementos e o conteúdo se adaptam de acordo com o tamanho da tela do usuario.  </p>
            </div>
        </section>
    )
}
